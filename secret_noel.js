...
module.exports = class SecretNoel {
	constructor() {
		...
		console.log(this.member_list[0]);
		console.log(this.member_list[1]);
		console.log(this.member_list[2]);
		this._getinfo();
		this._displayinfo();
		console.log('\n');
		this._sortinfo();
  ...
  _getinfo() {
		for(this.i = 0; this.i < (this.member_list.length); this.i++) {
